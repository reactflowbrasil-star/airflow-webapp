    ...
    <main id="conteudo" className="flex-1">
      <section className="relative overflow-hidden px-5 pt-14 pb-10">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="eyebrow text-[var(--accent-text)]">AirFlow Pro</p>
            <h1 className="mt-4 text-[clamp(34px,6vw,70px)] leading-[0.95] font-extrabold tracking-[-0.06em]">
              O app exclusivo do prestador de ar-condicionado
            </h1>
            <p className="text-secondary mt-5 max-w-2xl text-lg leading-relaxed">
              Instale no celular para receber alertas de serviços próximos, abrir
              negociações rapidamente e gerenciar sua operação direto do painel
              profissional.
            </p>
